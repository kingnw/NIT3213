...
class DashboardActivity : AppCompatActivity() {
    ...
    private fun fetchDashboardData(keypass: String) {
        ...
        val mockEntities = listOf(
            ...
            Entity("Burj Khalifa", "Adrian Smith", "Dubai, UAE", 2010, "Neo-futurism", 828, "The tallest structure and building in the world since topping out in 2009."),
            Entity("Guggenheim Museum Bilbao", "Frank Gehry", "Bilbao, Spain", 1997, "Deconstructivism", 50, "A museum of modern and contemporary art in Bilbao."),
            Entity("Pantheon", "Unknown", "Rome, Italy", 126, "Ancient Roman Architecture", 43, "A former Roman temple, now a church in Rome.")
        )
